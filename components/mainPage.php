...
//all the session variables are set to null or 0 if no current session 
...
<head>
  ...
  <style>
    <?php include "../assets/animateProducts.css" ?><?php include "../assets/myAdresses.css" ?><?php include "../assets/productsChoice.css" ?><?php include "../assets/mainPage.css" ?>
  </style>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.00, minimum-scale=1.00, maximum-scale=1.10">
</head>

<body>
  <section id="sectionmainpage">
    <div class="animation-products">
      <div class="slider">
        <ul class="slides">
          <li class="slide" id="slide1"><img id="slideimg1" src="https://picjumbo.com/wp-content/uploads/man-using-his-laptop-in-the-office-2210x1473.jpg" alt="">
            <div id="textAnimation1" class="textAnimation">
              <h1>Best quality products are here.</h1><br><button onclick='window.location.replace("productsChoice.php");'>See products</button>
            </div>
          </li>
          <li class="slide" id="slide2"><img id="slideimg2" src="https://unblast.com/wp-content/uploads/2020/04/Man-Holding-iPhone-Mockup-1.jpg" alt="">
            <div id="textAnimation2" class="textAnimation">
              <h1>See latest auctions now.</h1><br><button onclick='window.location.replace("allAuctions.php");'>Latest auctions</button>
            </div>
          </li>
          <li class="slide" id="slide3"><img id="slideimg3" src="https://picjumbo.com/wp-content/uploads/man-using-his-laptop-in-the-office-2210x1473.jpg" alt="">
            <div id="textAnimation1" class="textAnimation">
              <h1>Best quality products are here.</h1><br><button onclick='window.location.replace("productsChoice.php");'>See products</button>
            </div>
          </li>
    ...
    <div class="gif">
      <h1 style="font-size:35px">What are we ?</h1>
      ...
      <h1 style="font-size:35px">See our products</h1>
    </div>
    <div class="showOptions" style="background-color:transparent; margin-top:70px;">
      <button onclick='window.location.replace("phones.php")' class="option" id="option1"></button>
      <button onclick='window.location.replace("tablets.php");' class="option" id="option2"></button>
      <button onclick='window.location.replace("laptops.php");' class="option" id="option3"></button>
      <button onclick='window.location.replace("earphones.php");' class="option" id="option4"></button>
    </div>
  </section>
  <header>
    <div class="navbar">
  ...
  <div id="myModalMainPage" class="modal">
    <!-- Modal content -->
    <div class="modal-content">
      <span class="close">&times;</span>
      <h1>Welcome to Yourmarket !</h1>
      <h3>Find the best quality products here.</h3>
      <h3>From smartphones to earphones, you can choose between several purchasing methods :</h3>
      <h2><strong>Buy now, auctions, flash sales or best offers.</strong></h2>
      <h2 style="color:red">New !!</h2>
      <h3 style="color:red">Shipping costs are offered from 1500£ of purchase !</h3>
      <h3><a href="productsChoice.php">View all of our products here.</a></h3>
    </div>
  </div>
</body>
...
<script>
  <?php include "animeHeader.js" ?>
</script>
<script>
  <?php include "animationProducts.js" ?>
</script>
<script>
  <?php include "navApp.js" ?>
</script>
<script>
  <?php include "mainPage.js" ?>
</script>
