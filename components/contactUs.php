...
if (isset($_POST["submitresearch"]) && $_POST["submitresearch"]) {
  ...
  //if the users submits the message, an email is send to admin (eliott) with his message
if (isset($_POST["sub"]) && $_POST["sub"]) {
    $message = $_POST["message"];
    $email = "(" . $_SESSION["user"]->getEmail() . ") ";
    $fullname = $_SESSION["user"]->getFirstname() . " " . $_SESSION["user"]->getLastname();
    $object = $_SESSION["user"]->getFirstname() . ": " . $_POST["object"];
    $content = $fullname . $email . " said : '" . $message . "'";
    mail("eliott.morcillo@gmail.com", $object, $content, $header);
    echo "Message sent successfully. Back to home page.";
    ...
    <section>
        <div class="contactForm">
            <form action="" method="post">
                ...
                <input disabled type="text" name="name" value="<?php echo $_SESSION["user"]->getFirstname() . " " . $_SESSION["user"]->getLastname() ?>">
                <label for="email">
                    <h3>Email :</h3>
                </label>
                <input disabled type="email" name="email" value="<?php echo $_SESSION["user"]->getEmail() ?>">
                <label for="object">
                    <h3>Object :</h3>
                </label>
                ...
                <textarea required name="message" id="" cols="70" rows="15" placeholder="Your message..."></textarea>
                <input type="submit" name="sub" id="sendMessage" value="Submit">
            </form>
        </div>
    </section>
    <header>
...
<script src="../images/animeHeader.js"></script>
<script>
