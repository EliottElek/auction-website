...
//we select all auctions
$sql = mysqli_query($succes, $sql = "SELECT * FROM `auctions` WHERE 1");
$row = mysqli_num_rows($sql);
$compteur = 0;
while ($row > $compteur) {
  $result = mysqli_fetch_assoc($sql);
  $creations[$compteur] = new auction($result["category"], $result["brand"], $result["model"], $result["capacity"], $result["size"], $result["price"], $result["picture"], $result["description"], $result["id"], $result["currentBid"], $result["endingTime"], $result["bestBidder"]);
  $compteur = $compteur + 1;
}
if (!empty($creations)){
    shuffle($creations);
...
<body>
  <section>
    <h3 style="align-self:baseline; margin:50px;"><a href="mainPage.php">Home</a>><a href="allAuctions.php">Auctions</a></h3>
    <div class="showObjects">
      ...
      ?><div class="object">
          <table>
            ...
            <tbody>
              <tr>
                <td><a href="selectedObject.php?Id=<?= $creations[$i]->getId(); ?>&category=auctions"><img class = "image" src='<?php echo $creations[$i]->getPicture() ?>' alt=""></a></td>
              </tr>
              <tr>
                </td>
              </tr>
              <tr>
                <td>Current bid : <?php echo $creations[$i]->getCurrentBid() ?>£</td>
              </tr>
              <tr>
  ...
  <header>
    <div class="navbar">
      <ul id="nav_items">
        ...
        <li id="logoli"><a href="mainPage.php"><img id="logo" src="logoYourMarket.png" alt=""></a></li>
        <li id="categories" class="dropdown-categories">
          ...
          <div id="dropdown-child-categories1" class="dropdown-child-categories">
            ...
            <div class="pictures">
              <img id="navImage" src="iphone.jpg" alt="">
        ...
        <li id="buyings" class="dropdown-categories">
          ...
          <div id="dropdown-child-categories2" class="dropdown-child-categories">
            ...
            <div class="pictures">
              <img id="navImage2" src="Auction-label.png" alt="">
        ...
        <li class="dropdown" id="drop1">
          <a href="myChart.php"><img id="myAccountImg" src="logoBasket1.png" alt="">
        ...
        <li class="dropdown" id="drop2">
          <a href="myProfile.php"><img id="myAccountImg" src="user.png" alt=""></a>
...
<script src="animeHeader.js"></script>
<script>
